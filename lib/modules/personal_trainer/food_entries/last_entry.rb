require 'date'
# We need this for our date helpers
...
module PersonalTrainer
  module FoodEntries
    ...
    def last_entry (last_entry_date, hours_til_bug = 24)
      current_time = DateTime.now
      last_entry_modified = DateTime.parse(last_entry_date) + hours_til_bug.hours
